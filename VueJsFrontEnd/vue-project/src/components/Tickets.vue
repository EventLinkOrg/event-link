    ...
    <div class="row">
        <div class="col-lg-4 pb-5">
            ...
            <div class="author-card pb-3">
                <div class="author-card-cover" style="margin-top: 20px; background-image: url(https://bootdey.com/img/Content/flores-amarillas-wallpaper.jpeg);">
            ...
            <div class="wizard">
                <nav class="list-group list-group-flush">
                    ...
                    <!-- <router-link>
                        <a class="list-group-item" :to="{name: 'ProfileSettings'}"><i class="fa fa-user text-muted"></i>Profile Settings</a>
                    </router-link> -->
                    <router-link class="list-group-item" to="/profile-settings">
